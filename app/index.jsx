    ...
    <SafeAreaView style={{ backgroundColor: 'white' }} className="flex-1">
      <View className="flex-1 ">
        ...
        <View className=" h-1/2  px-5 gap-5 ">
          <Text className=" text-5xl font-bold text-center mt-10">Welcome 👋</Text>
          <Text className=" text-lg text-center mt-2 ">Don't miss a goal! Get live match notifications and match results from your favourite teams and world's most prestigious competitions!</Text>
