          ...
          <ScrollView contentContainerStyle={{ flexGrow: 1 }} className="p-8">
            <View className="flex-1 mt-5 gap-10 justify-center">
              ...
              <View className="justify-center items-center mt-5">
                <View className="flex-row justify-center items-center"><Text>Already have an account?</Text><TouchableOpacity className="ms-2 border-b" onPress={() => (router.push("Login"))}><Text>Log In </Text></TouchableOpacity></View>
              </View>
            </View>
          </ScrollView>
        </KeyboardAwareScrollView>
